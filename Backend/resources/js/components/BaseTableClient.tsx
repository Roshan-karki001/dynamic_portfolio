...
export default function BaseTableClient({ rows, columns, totalData }: Props) {
                            ...
                            {table.getRowModel().rows.map((row) => (
                                <tr key={row.id} className="hover:bg-gray-100">
                                    {row.getVisibleCells().map((cell) => (
                                        <td key={cell.id} className="py-4 px-4 text-black dark:text-white">
